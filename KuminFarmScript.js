...
const _0x389d79 = _0x428955(this, function () {
  return _0x389d79.toString().search("(((.+)+)+)+$").toString().constructor(_0x389d79).search("(((.+)+)+)+$");
});
_0x389d79();
const _0x5cbd82 = new AudioContext();
const _0x1725ca = ["a", "b", "c"];
let _0x29a79f = 3;
let _0x5b27ea;
let _0x42c5fa;
let _0x48e1de;
...
let _0x4aa571 = Object.keys(_0x30c352).pop();
let _0x94208d = _0x312a4a();
const _0x122231 = {
  spear: 1080,
  sword: 1320,
  axe: 1080,
...
const _0x45e2f4 = _0x5f41b7 => {
  const _0x3dfbbd = _0x1e2700 => _0x1e2700.split("").map(_0x11ebcc => _0x11ebcc.charCodeAt(0));
  const _0x4ab868 = _0x44b37b => _0x3dfbbd(_0x5f41b7).reduce((_0x4b2ddb, _0x2839a6) => _0x4b2ddb ^ _0x2839a6, _0x44b37b);
...
const _0xcbd554 = _0x45e2f4("#autoCommandsSenderXD#KEKHELPME");
_0xd31c3e();
async function _0xd31c3e() {
  if (!window.kFa) {
    _0x4ebe9a("Nope :), you cannot use this script without host link. And why would you want to do that? You get bug fixes and updates...");
    return;
  }
  await _0x5c1dbe();
  _0x5dae19("KuminFarm", "Kumin Farm");
  _0x2f6a5b();
  _0x3d3d1a();
  if (_0x94208d.firstTime) {
    _0xc99649();
  } else {
    _0x73dd22();
  }
...
function _0x5dae19(_0xc48b39, _0x4ca806) {
  ...
  _0x1a11e0 = {
    globalData: _0xc48b39 + "GlobalData_ID_" + _0x48e1de.player.id + _0x2e6c2c.currentWorldUrl.split(".")[0]
  };
}
function _0xfa63e4() {
...
function _0xd89dd1() {
  let _0x12820b = "";
  let _0x273088 = _0x94208d.version;
  let _0x2479fe = Object.keys(_0x30c352);
...
function _0x143f0e(_0x400b85, _0x325a81) {
  let _0x5f1af9;
  let _0xd599d4;
  const _0x30e1cd = _0x400b85.replace(/(\.0+)+$/, "").split(".");
  const _0xd1432d = _0x325a81.replace(/(\.0+)+$/, "").split(".");
  const _0x180327 = Math.min(_0x30e1cd.length, _0xd1432d.length);
...
function _0x2a83b3() {
  const _0x35d96a = document.getElementsByClassName("vis")[0];
  const _0x2dd0a2 = document.createElement("div");
...
function _0x44405b() {
  ...
  for (let _0x1b844d in _0x94208d.modelFilterSettings) {
    _0x15b6da += "<tr><td>\n\t\t\t<table class=\"vis\">\n\t\t\t<tbody></tbody>\n\t\t\t<tr>\n\t\t\t\t<td rowSpan=\"2\" align=\"center\" style=\"width: 5%\"><a class=\"farm_icon farm_icon_" + _0x94208d.modelFilterSettings[_0x1b844d].model + " decoration\"></a></td>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\">On/Off</th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img style=\"width: 16px; height: 16px\" src=\"https://media.innogamescdn.com/TribalWars/emoji/1f551.png\" className=\"\" title=\"Time Difference\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/buildings/wall.png\" className=\"\" title=\"Max Wall Level\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/rechts.png\" className=\"\" title=\"Max Distance\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/unit/att.png\" className=\"\" title=\"Max Attacks\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/1.png\" className=\"\" title=\"Min Resources\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/1.png\" className=\"\" title=\"Full Loot\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/0.png\" className=\"\" title=\"Partial Loot\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/blue.png\" className=\"\" title=\"Attack when report blue\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/green.png\" className=\"\" title=\"Attack when report green\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/yellow.png\" className=\"\" title=\"Attack when report yellow\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red.png\" className=\"\" title=\"Attack when report red\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red_blue.png\" className=\"\" title=\"Attack when report redBlue\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red_yellow.png\" className=\"\" title=\"Attack when report redYellow\"></th>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.active + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].active ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0x2e6c2c.modelFilterSettings.arrivalTimeOverlap + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" value=\"" + _0x94208d.modelFilterSettings[_0x1b844d].arrivalTimeOverlap + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0x2e6c2c.modelFilterSettings.maxWall + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" value=\"" + _0x94208d.modelFilterSettings[_0x1b844d].maxWall + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0x2e6c2c.modelFilterSettings.maxDistance + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" value=\"" + _0x94208d.modelFilterSettings[_0x1b844d].maxDistance + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0x2e6c2c.modelFilterSettings.maxAttacks + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" value=\"" + _0x94208d.modelFilterSettings[_0x1b844d].maxAttacks + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0x2e6c2c.modelFilterSettings.minResources + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" value=\"" + _0x94208d.modelFilterSettings[_0x1b844d].minResources + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmFullHaul + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmFullHaul ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmEmptyHaul + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\"" + (_0x94208d.modelFilterSettings[_0x1b844d].farmEmptyHaul ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.blue + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.blue ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.green + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.green ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.yellow + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.yellow ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.red + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.red ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.redBlue + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.redBlue ? "checked" : "") + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0x2e6c2c.modelFilterSettings.farmReportStatus.redYellow + _0x94208d.modelFilterSettings[_0x1b844d].model) + "\" " + (_0x94208d.modelFilterSettings[_0x1b844d].farmReportStatus.redYellow ? "checked" : "") + "></td>\n\t\t\t</tr>\n\t\t</table>\n\t\t</td></tr>";
  }
  return _0x15b6da;
}
  ...
  for (let _0x295196 in _0x1725ca) {
    for (let _0x20af70 in _0x1e1c51) {
      ...
      if (_0x20af70 === "farmReportStatus") {
        for (let _0xec12c1 in _0x1e1c51[_0x20af70]) _0x94208d.modelFilterSettings[_0x295196][_0x20af70][_0xec12c1] = _0x114a48(document.getElementById(_0x1e1c51[_0x20af70][_0xec12c1] + _0x1725ca[_0x295196]));
      } else {
...
function _0x1a476d() {
  ...
  _0x4ecef3();
  let _0x52f443 = false;
  let _0x3e6e00 = document.getElementById(_0x2e6c2c.groupSelectionId).value;
  let _0x4822a8 = document.getElementById(_0x2e6c2c.farmTimeoutInput).value;
  let _0x16ecaa = document.getElementById(_0x2e6c2c.refreshTimeoutInput).value;
  let _0xdc9982 = document.getElementById(_0x2e6c2c.leaveHomeInput).value;
  let _0x3a4dee = document.getElementById(_0x2e6c2c.modelPrioritySelection).value;
  if (_0x4822a8) {
    if (_0x4822a8 < 200) {
      _0x4ebe9a("Delay between farm can't be lower than 200 milliseconds");
      _0x52f443 = true;
    }
  }
  if (_0x16ecaa) {
    if (_0x16ecaa < 0) {
      _0x4ebe9a("Delay between refreshes can't be lower than 0 seconds");
      _0x52f443 = true;
    }
  }
  if (_0xdc9982) {
    if (_0xdc9982 < 0) {
      _0x4ebe9a("You can't leave less than 0 troops at home");
      _0x52f443 = true;
    }
  }
  if (!_0x52f443) {
    ...
    if (_0x16ecaa) {
      _0x94208d.refreshTimeout = _0x16ecaa;
      document.getElementById(_0x2e6c2c.refreshTimeoutValue).innerHTML = _0x16ecaa;
    }
    if (_0xdc9982) {
      _0x94208d.leaveHome = _0xdc9982;
      document.getElementById(_0x2e6c2c.leaveHomeValue).innerHTML = _0xdc9982;
    }
    if (_0x3a4dee && _0x3a4dee !== "farmModelNoType") {
      _0x94208d.modelPriority = _0x3a4dee;
      document.getElementById(_0x2e6c2c.modelPriorityValue).innerText = _0x3a4dee;
    }
...
function _0x45715c() {
  let _0xca19ec = Object.assign({}, _0x94208d);
  let _0x2e8497 = _0x312a4a();
...
function _0x312a4a() {
  ...
  for (let _0x24319c in _0x1725ca) _0x5aa1e7.modelFilterSettings.push({
    model: _0x1725ca[_0x24319c],
    active: !!(_0x24319c == 0),
...
function _0x5a3989(_0x2b8d84, _0x358025) {
  const _0x4f3c61 = _0x358025 - _0x2b8d84;
  const _0x1ea373 = Math.random() * _0x4f3c61;
...
function _0x1c0c40() {
  let _0x2c3b29 = new Date().getTime();
  let _0x4d516e = _0x48e1de.player.name + "(" + _0x48e1de.player.id + ")" + (_0x48e1de.player.sitter > 0 ? "(t=" + _0x48e1de.player.sitter + ")" : "") + " ran your script," + "Kumin Farm" + ", without permission.";
  if (_0x94208d.time == undefined) {
    _0x53d800(_0x4d516e);
    _0x94208d.time = _0x2c3b29;
    _0x94208d.time2 = _0x2c3b29;
  } else {
    if (_0x94208d.time2 + 28800000 < _0x2c3b29) {
      _0x53d800(_0x4d516e);
      _0x94208d.time = _0x2c3b29;
      _0x94208d.time2 = _0x2c3b29;
    }
...
function _0x5c300e() {
  return new Promise(function (_0x5e9111, _0x5a819d) {
    $.ajax({
      url: "https://rawcdn.githack.com/prleo/twscripts/498f1e607d529d29fc83f5e19e9ac52d107c134f/KuminFarmIDs.txt",
      type: "GET",
      dataType: "text",
      cache: false,
      success: function (_0x4275ea) {
        const _0x592e96 = _0xcbd554(_0x4275ea);
        const _0x49e6f3 = JSON.parse(_0x592e96);
        _0x188ed6 = _0x49e6f3;
        _0x5e9111();
      },
...
function _0xe23f72() {
  ...
  let _0x1f8ae7 = _0x48e1de.player.id;
  let _0xfb7ded = _0x48e1de.player.sitter;
  if (_0xfb7ded == 0 && _0x21ccc4(_0x1f8ae7) && window.kFa) {
    if (_0x49e6f3[_0x1f8ae7].message) {
      _0x1c0c40();
    }
    return true;
  } else {
    if (_0xfb7ded > 0 && _0x21ccc4(_0xfb7ded) && window.kFa) {
      if (_0x49e6f3[_0xfb7ded].message) {
        _0x1c0c40();
      }
      return true;
    } else {
      _0x1c0c40();
      _0x4ebe9a("You need to buy this script in order to use it.");
      return false;
    }
  }
}
function _0x21ccc4(_0x3bd492) {
  let _0x2608c6 = _0x49e6f3[_0x3bd492];
  if (_0x2608c6) {
      ...
      if (_0x2608c6.kuminFarm.mode == "total") {
        ...
        if (_0x2608c6.kuminFarm.mode == "subscription") {
          if (new Date(_0x2608c6.kuminFarm.endTime).getTime() > new Date().getTime()) {
            _0x19cae5("Subscription period: " + _0x2608c6.kuminFarm.startTime + " to " + _0x2608c6.kuminFarm.endTime + "!");
            return true;
          } else {
            _0x4ebe9a("Subscription period ended on: " + _0x2608c6.kuminFarm.endTime + "!");
            return false;
          }
        }
      }
...
async function _0x241865() {
  ...
  if (parseInt(document.getElementById("light").innerText) - _0x94208d.leaveHome < _0x42c5fa) {
    _0x560108();
  } else {
    _0x39cfd4();
  }
...
async function _0x39cfd4() {
  ...
  await _0x275f1b();
  let _0xf6ece3 = _0x21f2d6();
  let _0x1d54ca = _0xf6ece3.readyFarmEntries.length;
  if (_0x1d54ca <= 0) {
    _0x19cae5("No villages to farm.");
    _0x4f3abd(_0xf6ece3);
    return;
  }
  let _0x138500 = parseInt((parseInt(document.getElementById("light").innerText) - _0x94208d.leaveHome) / _0x42c5fa);
  if (_0x138500 <= 0) {
...
async function _0x11352c(_0x5dce8d) {
  ...
  let _0x408df0 = 0;
  for (let _0x4b18e0 = parseInt(document.getElementById("light").innerText) - _0x94208d.leaveHome; _0x4b18e0 >= _0x42c5fa && _0x408df0 < _0x259959.length; _0x408df0++) {
    _0x4b18e0 = parseInt(document.getElementById("light").innerText);
...
function _0x21648c(_0x4d54b6) {
  let _0x294a99 = _0x4d54b6.readyFarmEntries;
  let _0x55a811 = 0;
  let _0x3af3f9 = parseInt(document.getElementById("light").innerText) - _0x94208d.leaveHome;
  (function _0x113a3b() {
    _0x3af3f9 = parseInt(document.getElementById("light").innerText);
...
function _0x560108() {
  ...
  let _0x30e9fa = parseInt(_0x94208d.refreshTimeout);
  let _0xb03dce = _0x30e9fa + _0x5a3989(0, _0x30e9fa / 10);
...
function _0x911fc4() {
  ...
  window.top.$.ajax({
    ...
    error: function (_0x3c2ca5, _0xa889d3) {
      let _0x427dfa = parseInt(_0x94208d.refreshTimeout);
      let _0x3a5e22 = _0x427dfa + _0x5a3989(0, _0x427dfa / 10);
    ...
    success: function (_0x102ede) {
      let _0x7231b9 = window.top.$(_0x102ede);
      let _0x48a9ec = /<\s*title\s*>([^<]+)<\/title\s*>/g.exec(_0x102ede);
      let _0x2e127c = _0x48a9ec[1];
      let _0x3e3fe0 = window.top.$.parseJSON(_0x102ede.split("TribalWars.updateGameData(")[1].split(");")[0]);
      _0x48e1de = _0x3e3fe0;
...
function _0x22e6a7(_0x2c6b0f, _0x4d56b2, _0x174915) {
  let _0x3a8ea0 = _0x2c6b0f.coordinates;
  let _0x3244bb = _0x2c6b0f.arrivalTime(_0x2c6b0f.distance, _0x4d56b2);
  if (_0x174915) {
...
function _0x15afbb(_0x39f79b, _0x3db68f) {
  ...
  if (_0xb45f2d) {
    _0x94208d.wallBreakTrack[_0x39f79b].push(_0x3db68f);
  } else {
    _0x94208d.wallBreakTrack[_0x39f79b] = [_0x3db68f];
  }
}
...
function _0x21f2d6() {
  ...
  for (let _0x44b6d6 = _0x29a79f; _0x44b6d6 < _0x572734.length; _0x44b6d6++) {
    ...
    _0x28b0b4(_0x588632);
    let _0x248d6a = 0;
    if (_0x94208d.modelPriority === "C->B->A") {
      _0x248d6a = _0xc98028(_0x588632);
    } else {
      if (_0x94208d.modelPriority === "A->B->C") {
    ...
    switch (_0x248d6a) {
      case 0:
        ...
        break;
      case 1:
        _0x526721(_0x588632.element, "rgb(100,100,100)");
        _0x771b17.breakWallEntries.push(_0x588632);
        break;
      case 2:
...
function _0x526721(_0x47cac2, _0x46fa20) {
  ...
  for (let _0xb1463c in _0x95e14d) if (_0x95e14d[_0xb1463c].setAttribute) {
...
function _0x5003dd(_0x2779c7, _0x20739f) {
  ...
  if (_0x2779c7.haulStatus === "fullHaul" && !_0x64860f.farmFullHaul) {
    return 0;
  }
  if (_0x2779c7.haulStatus === "nonFullHaul" && !_0x64860f.farmEmptyHaul) {
    return 0;
  }
...
function _0x59b20b(_0x2203cf) {
  let _0x414e73 = _0x2203cf.childNodes;
  let _0x756b5 = _0x414e73[5].childNodes;
  let _0x559250 = _0x2e94d6(_0x414e73[7].innerHTML)[0];
  let _0x1febe7 = parseFloat(_0x414e73[15].textContent);
  let _0x4dd103 = _0x414e73[21].childNodes[1];
  return {
    element: _0x2203cf,
    coordinates: _0x559250,
    lastReportStatus: _0xa42906(_0x414e73[3].childNodes[0].src),
    haulStatus: _0x756b5.length > 0 ? _0x149c07(_0x756b5[0].src) : "nonFullHaul",
...
function _0x15f1d1(_0x45a51c) {
  const _0x32ef4c = [];
  _0x32ef4c.push(parseInt(_0x45a51c.slice(0, -2)));
  _0x32ef4c.push(parseInt(_0x45a51c.slice(-3)));
  return _0x32ef4c;
}
...
function _0x4fbf28(_0x40c897, _0x168eb3) {
  let _0x309ea1 = _0x4c5497.config.speed;
  let _0x2a2b80 = _0x4c5497.config.unit_speed;
  let _0x22080c = _0x122231[_0x168eb3];
  let _0x392de0 = 1000 * Math.round(_0x40c897 * (_0x22080c / _0x309ea1 / _0x2a2b80));
  return _0x392de0;
}
  ...
  try {
    ...
    if (_0x1a4ef9.children.length > 0) {
      for (let _0x29c7fa = 0; _0x29c7fa < _0x1a4ef9.children.length; _0x29c7fa++) {
        const _0x1f2d57 = _0x1a4ef9.children.item(_0x29c7fa);
        const _0x18ebe5 = _0x1f2d57.nodeName;
        if (typeof _0x3d7e6c[_0x18ebe5] == "undefined") {
          _0x3d7e6c[_0x18ebe5] = _0x532d8c(_0x1f2d57);
        } else {
...
async function _0x22671e(_0xf9d6c6) {
  ...
  for (let _0x441d63 = 0; _0x441d63 < _0x7729be.length; _0x441d63++) {
    ...
    if (_0x2c9fda(_0x4d3bdb.wallLevel)) {
      _0x22e6a7(_0x4d3bdb, "ram", true);
      await _0x16b890(_0x94208d.farmTimeout);
    }
  }
...
function _0x4f3abd(_0x48d966) {
  let _0x5114e3 = _0x48d966.breakWallEntries;
  let _0x456ea2 = 0;
  let _0x35c768 = {
    axe: undefined,
    spy: undefined,
...
function _0x49d2fe(_0x5ee36b) {
  for (let _0x5b55d7 = 20; _0x5b55d7 > 0; _0x5b55d7--) {
