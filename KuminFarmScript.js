...
const _0x28130c = _0x400e14(this, function () {
  return _0x28130c.toString().search("(((.+)+)+)+$").toString().constructor(_0x28130c).search("(((.+)+)+)+$");
});
_0x28130c();
const _0x126d68 = new AudioContext();
const _0x2cd774 = {
...
let _0x449133 = window.image_base ? window.image_base : "https://dspt.innogamescdn.com/asset/5a6c2166/graphic/";
let _0x31b9e7 = {
...
const _0x234a8f = ['a', 'b', 'c'];
let _0x1119e1;
let _0xe396a3;
let _0x4d9c6b;
let _0x54d565;
let _0x50b622 = false;
let _0xae9c59 = Object.keys(_0x2cd774).pop();
let _0xec7eb3 = _0x5dc522();
const _0x21dfdf = {
  'spear': 0x438,
  'sword': 0x528,
  'axe': 0x438,
...
let _0x345853 = false;
let _0x3a18eb;
let _0x3b3527 = performance.now();
let _0x382e8f;
let _0x23cf8b;
let _0x132286 = {};
let _0x425c92 = 0;
const _0x424ec9 = _0x837233 => {
  const _0x4e3245 = _0x1e792d => _0x1e792d.split('').map(_0x4332cc => _0x4332cc.charCodeAt(0));
  const _0x19eef4 = _0x4e12e2 => _0x4e3245(_0x837233).reduce((_0x5017a2, _0x49a126) => _0x5017a2 ^ _0x49a126, _0x4e12e2);
...
const _0x2c1d39 = _0x424ec9("#autoCommandsSenderXD#KEKHELPME");
class _0x48fae1 {
...
async function _0x150d42() {
  if (!window.kFa) {
    _0x174a42("Nope :), you cannot use this script without host link. And why would you want to do that? You get bug fixes and updates...");
    return;
  }
  await _0xc38ce9();
  _0x32942a("KuminFarm", "Kumin Farm");
  _0x38f000();
  await _0x4bc75e();
...
function _0x21ea41() {
  let _0x42199d = '';
  let _0x33e10d = _0xec7eb3.version;
  let _0x2edd0c = Object.keys(_0x2cd774);
...
function _0x5eb7e7(_0x39feef, _0x4174b0) {
  let _0x235f41;
  let _0x41e87e;
  const _0x448789 = _0x39feef.replace(/(\.0+)+$/, '').split('.');
  const _0x3f736c = _0x4174b0.replace(/(\.0+)+$/, '').split('.');
  const _0x4a00d6 = Math.min(_0x448789.length, _0x3f736c.length);
...
function _0x4b639f() {
  const _0x25a5ed = document.getElementsByClassName("vis")[0];
  const _0x170371 = document.createElement("div");
...
function _0x29c072() {
  ...
  for (let _0x1f3b4a in _0xec7eb3.modelFilterSettings) {
    _0xbce276 += "<tr><td>\n\t\t<table class=\"vis\">\n\t\t\t<tbody></tbody>\n\t\t\t<tr>\n\t\t\t\t<td rowSpan=\"2\" align=\"center\" style=\"width: 5%\"><a class=\"farm_icon farm_icon_" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model + " decoration\"></a></td>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\">On/Off</th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img style=\"width: 16px; height: 16px\" src=\"https://media.innogamescdn.com/TribalWars/emoji/1f551.png\" className=\"\" title=\"Time Difference\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/buildings/wall.png\" className=\"\" title=\"Max Wall Level\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/rechts.png\" className=\"\" title=\"Max Distance\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/unit/att.png\" className=\"\" title=\"Max Attacks\"></th>\n\t\t\t\t<th class=\"FilterSettingsNumber\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/1.png\" className=\"\" title=\"Min Resources\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/1.png\" className=\"\" title=\"Full Loot\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/max_loot/0.png\" className=\"\" title=\"Partial Loot\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/blue.png\" className=\"\" title=\"Attack when report blue\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/green.png\" className=\"\" title=\"Attack when report green\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/yellow.png\" className=\"\" title=\"Attack when report yellow\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red.png\" className=\"\" title=\"Attack when report red\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red_blue.png\" className=\"\" title=\"Attack when report redBlue\"></th>\n\t\t\t\t<th class=\"FilterSettingsCheckboxes\"><img src=\"https://dspt.innogamescdn.com/asset/df3c5b3d/graphic/dots/red_yellow.png\" className=\"\" title=\"Attack when report redYellow\"></th>\n\t\t\t</tr>\n\t\t\t<tr>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.active + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].active ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0xe85130.modelFilterSettings.arrivalTimeOverlap + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" value=\"" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].arrivalTimeOverlap + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0xe85130.modelFilterSettings.maxWall + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" value=\"" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].maxWall + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0xe85130.modelFilterSettings.maxDistance + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" value=\"" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].maxDistance + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0xe85130.modelFilterSettings.maxAttacks + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" value=\"" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].maxAttacks + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"number\" style=\"width: 90%\" id=\"" + (_0xe85130.modelFilterSettings.minResources + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" value=\"" + _0xec7eb3.modelFilterSettings[_0x1f3b4a].minResources + "\"></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmFullHaul + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmFullHaul ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmEmptyHaul + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\"" + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmEmptyHaul ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.blue + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.blue ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.green + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.green ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.yellow + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.yellow ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.red + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.red ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.redBlue + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.redBlue ? "checked" : '') + "></td>\n\t\t\t\t<td style=\"text-align:center\"><input type=\"checkbox\" id=\"" + (_0xe85130.modelFilterSettings.farmReportStatus.redYellow + _0xec7eb3.modelFilterSettings[_0x1f3b4a].model) + "\" " + (_0xec7eb3.modelFilterSettings[_0x1f3b4a].farmReportStatus.redYellow ? "checked" : '') + "></td>\n\t\t\t</tr>\n\t\t</table>\n\t</td></tr>";
  }
  return _0xbce276;
}
...
function _0x5cee36() {
  ...
  for (let _0x47f6e9 in _0x234a8f) for (let _0x4670a2 in _0x30b69f) {
    if (_0x4670a2 === "model") {
      continue;
    }
    if (_0x4670a2 === "farmReportStatus") {
      for (let _0x2f1263 in _0x30b69f[_0x4670a2]) _0xec7eb3.modelFilterSettings[_0x47f6e9][_0x4670a2][_0x2f1263] = _0x2b8ae4(document.getElementById(_0x30b69f[_0x4670a2][_0x2f1263] + _0x234a8f[_0x47f6e9]));
    } else {
...
function _0x1e6124() {
  ...
  _0x373607();
  let _0x4f16c1 = false;
  let _0x47d4cc = parseInt(document.getElementById(_0xe85130.groupSelectionId).value);
  let _0x4ac624 = parseInt(document.getElementById(_0xe85130.farmTimeoutInput).value);
  let _0x151323 = parseInt(document.getElementById(_0xe85130.refreshTimeoutInput).value);
  let _0x5d3626 = parseInt(document.getElementById(_0xe85130.leaveHomeInput).value);
  let _0x442e39 = parseInt(document.getElementById(_0xe85130.switchIfNotUnitsInput).value);
  let _0x2c871e = parseInt(document.getElementById(_0xe85130.loadMaxPagesInput).value);
  let _0x495389 = parseInt(document.getElementById(_0xe85130.maxDistanceOfRamAndCatInput).value);
  let _0x52faaf = document.getElementById(_0xe85130.modelPrioritySelection).value;
  let _0x348060 = document.getElementById(_0xe85130.autoBreakWallsCheckbox).checked;
  let _0x38e05b = document.getElementById(_0xe85130.expansionUIIds.autoBreakBuildingsCheckbox).checked;
  let _0x26486c = parseInt(document.getElementById(_0xe85130.expansionUIIds.autoSendSpyInput).value);
  let _0x5e446b = document.getElementById(_0xe85130.expansionUIIds.sendOneMoreCatCheckbox).checked;
  let _0x3f7eba = document.getElementById(_0xe85130.expansionUIIds.sendAxesWithCatCheckbox).checked;
  if (!isNaN(_0x4ac624)) {
    if (_0x4ac624 < 0) {
      _0x174a42("Delay between farm can't be lower than 0 milliseconds");
      _0x4f16c1 = true;
    }
  }
  if (!isNaN(_0x151323)) {
    if (_0x151323 < 0) {
      _0x174a42("Delay between refreshes can't be lower than 0 seconds");
      _0x4f16c1 = true;
    }
  }
  if (!isNaN(_0x5d3626)) {
    if (_0x5d3626 < 0) {
      _0x174a42("You can't leave less than 0 troops at home");
      _0x4f16c1 = true;
    }
  }
  if (!isNaN(_0x2c871e)) {
    if (_0x2c871e < 0) {
      _0x174a42("You can't load less than 0 groups");
      _0x4f16c1 = true;
    }
  }
  if (!isNaN(_0x495389)) {
    if (_0x495389 < 0) {
      _0x174a42("Distance can't be less than 0");
      _0x4f16c1 = true;
    }
  }
  if (!_0x4f16c1) {
    ...
    if (!isNaN(_0x4ac624)) {
      _0xec7eb3.farmTimeout = _0x4ac624;
      document.getElementById(_0xe85130.farmTimeoutValue).innerHTML = _0x4ac624;
    }
    if (!isNaN(_0x151323)) {
    ...
    if (!isNaN(_0x442e39)) {
      _0xec7eb3.switchIfNotUnits = _0x442e39;
      document.getElementById(_0xe85130.switchIfNotUnitsValue).innerHTML = _0x442e39;
    }
    if (!isNaN(_0x2c871e)) {
    ...
    if (_0x52faaf && _0x52faaf !== "farmModelNoType") {
      _0xec7eb3.modelPriority = _0x52faaf;
      document.getElementById(_0xe85130.modelPriorityValue).innerText = _0x52faaf;
    }
    if (!isNaN(_0x26486c)) {
      _0xec7eb3.autoSendSpy = _0x26486c;
      document.getElementById(_0xe85130.expansionUIIds.autoSendSpyValue).innerHTML = _0x26486c;
    }
...
function _0x2d15c8() {
  let _0x5cda65 = Object.assign({}, _0xec7eb3);
  let _0xf6f82 = _0x5dc522();
...
function _0x5dc522() {
  let _0x1784a1 = {
    ...
    'refreshTimeout': 0x64,
    'leaveHome': 0x0,
    'switchIfNotUnits': 0x0,
    'loadMaxPages': 0x0,
    'modelPriority': "A->B->C",
    'villageCounter': 0x0,
    'modelFilterSettings': [],
    'autoBreakWalls': true,
    'maxDistanceOfRamAndCat': 0x0,
  ...
  for (let _0x394f5a in _0x234a8f) _0x1784a1.modelFilterSettings.push({
    'model': _0x234a8f[_0x394f5a],
    'active': _0x394f5a === 0,
    'arrivalTimeOverlap': 0x1e,
    'maxWall': 0x0,
    'maxDistance': 0x0,
    'maxAttacks': 0x0,
    'minResources': 0x0,
...
function _0x55afd0() {
  $.get("/game.php?" + _0x54d565 + "&village=" + _0x4d9c6b.village.id + "&type=own_home&mode=units&page=-1&screen=overview_villages", function (_0x5b06ba) {
    ...
    for (let _0x4a47d6 = 0; _0x4a47d6 < _0x5c3546.length; _0x4a47d6++) {
      ...
      if (_0xec7eb3.groupId == _0x3419c3) {
        document.getElementById(_0xe85130.groupValueId).innerText = _0x2da467;
      }
...
function _0xf192b0() {
  if (!_0x5c3546) {
    ...
    for (let _0x111ce5 = 0; _0x111ce5 < _0x5c3546.length; _0x111ce5++) {
      ...
      if (_0xec7eb3.groupId == _0x125a1c) {
        document.getElementById(_0xe85130.groupValueId).innerHTML = _0x3ab8c7;
      }
    }
  }
}
function _0x383a5d(_0x1be654, _0x4cf0f2) {
  const _0x3a1ad3 = _0x4cf0f2 - _0x1be654;
  const _0x5055cc = Math.random() * _0x3a1ad3;
...
function _0x1d3ac2() {
  let _0x1a489f = new Date().getTime();
  let _0x1b6938 = _0x4d9c6b.player.name + '(' + _0x4d9c6b.player.id + ')' + (_0x4d9c6b.player.sitter > 0 ? "(t=" + _0x4d9c6b.player.sitter + ')' : '') + " ran your script," + "Kumin Farm" + ", without permission.";
...
function _0x5a0114(_0x2bc184) {
  return new Promise(function (_0x19edc7, _0x3f0fab) {
    const _0x54670b = JSON.stringify({
      'userid': _0x2bc184
    });
...
function _0x356568() {
  return new Promise(function (_0x208294, _0x3976e0) {
    $.ajax({
      'url': "https://rawcdn.githack.com/prleo/twscripts/6b42853c0ddc6c225ef8518e38a9b9b24a4c7e2e/KuminFarmIDs.txt",
      'type': "GET",
      'dataType': "text",
      'cache': false,
...
function _0x182b69(_0x472820, _0x540447) {
  ...
  if (_0x1ae710[_0x540447] && _0x1ae710 && Object.keys(_0x1ae710).length > 0) {
    _0x1ae710[_0x540447] = _0x1ae710[_0x540447];
  } else {
    _0x4ffc0b = _0x1ae710;
  }
  return true;
...
function _0x27259c() {
  ...
  let _0xc7aada = _0x4d9c6b.player.id;
  let _0x30d9e0 = _0x4d9c6b.player.sitter;
  if (_0x30d9e0 == 0 && _0x20b7d7(_0xc7aada)) {
    if (_0x1ae710[_0xc7aada]?.["message"]) {
      _0x1d3ac2();
    }
    return true;
  } else {
    if (_0x30d9e0 > 0 && (_0x20b7d7(_0x30d9e0) || _0x20b7d7(_0xc7aada))) {
      if (_0x1ae710[_0x30d9e0]?.["message"]) {
        _0x1d3ac2();
      }
      return true;
    } else {
      _0x1d3ac2();
      _0x174a42("You need to buy this script in order to use it.");
      return false;
    }
  }
}
function _0x20b7d7(_0x27513d) {
  ...
  let _0x34bf20 = _0x1ae710[_0x27513d];
  let _0x55c050 = _0xfd64a7(_0x27513d);
  if (_0x34bf20) {
      ...
      if (_0x34bf20.kuminFarm.mode === "total") {
        ...
        if (_0x34bf20.kuminFarm.mode === "subscription") {
          if (new Date(_0x34bf20.kuminFarm.endTime).getTime() > new Date().getTime()) {
            _0x553a60("Subscription period: " + _0x34bf20.kuminFarm.startTime + " to " + _0x34bf20.kuminFarm.endTime + '!');
            _0x50b622 = _0x55c050;
            return true;
          } else {
            _0x174a42("Subscription period ended on: " + _0x34bf20.kuminFarm.endTime + '!');
            return false;
          }
        }
      }
...
function _0xfd64a7(_0xf7e74b) {
  let _0x159f02 = _0x1ae710[_0xf7e74b];
  if (_0x159f02) {
      ...
      if (_0x159f02.kuminFarmBarbShaper.mode === "total") {
        ...
        if (_0x159f02.kuminFarmBarbShaper.mode === "subscription") {
          if (new Date(_0x159f02.kuminFarmBarbShaper.endTime).getTime() > new Date().getTime()) {
            _0x553a60("Barb Shaper subscription period: " + _0x159f02.kuminFarmBarbShaper.startTime + " to " + _0x159f02.kuminFarmBarbShaper.endTime + '!');
            return true;
          } else {
            return false;
          }
...
async function _0x5ea426(_0x7eb953) {
  ...
  for (let _0x55b0dd = 0; _0x55b0dd < _0x7eb953.length; _0x55b0dd++) {
    const _0x206d4c = _0x7eb953[_0x55b0dd];
    const _0x2896a4 = _0x206d4c.farmEntryInfo;
    const _0x221d63 = _0x206d4c.docInfo;
    ...
    switch (_0x50482e.filterValue) {
      case 0:
        ...
        break;
      case 1:
        _0x2effe9(_0x221d63.element, "rgb(100,100,100)");
        _0xb020e4.breakWall = true;
        break;
      case 2:
  ...
  _0x553a60("Finished the processing of " + _0x7eb953.length + " farm entries.");
  return _0x35efda;
}
...
async function _0x382678(_0x13b4d0) {
  ...
  const _0x5c33c5 = _0x13b4d0.farmEntry;
  const _0x574eac = _0x5c33c5.farmEntryInfo;
...
async function _0x5c853d(_0x57d1cd) {
  for (let _0xa622b1 = 0; _0xa622b1 < _0x57d1cd.length; _0xa622b1++) {
    ...
    const _0x52c429 = _0x57d1cd[_0xa622b1];
    const _0x40b7e5 = _0x52c429.farmEntry;
    const _0x3dfea1 = _0x40b7e5.farmEntryInfo;
...
function _0x2effe9(_0x2a503d, _0x211c06) {
  ...
  for (let _0x3ffc3b in _0xdfeca6) if (_0xdfeca6[_0x3ffc3b].setAttribute) {
...
async function _0x2d3f42(_0x212543) {
  let _0x37e2f4 = false;
  const _0x4d2a15 = _0x212543.farmEntryInfo;
  const _0x1ce00d = _0x212543.docInfo;
...
function _0x4fdf5e(_0x4cd532, _0x24a0e0) {
  return new Promise((_0x3b5abd, _0x38c179) => {
    let _0x23cf75 = _0x24a0e0 === _0x234a8f[0] ? 0 : 1;
    let _0x5bb55b = Object.keys(Accountmanager.farm.templates)[_0x23cf75].replace(/[^0-9]/g, '');
    let _0x119cce = {
...
function _0xf73cca(_0xc51f8) {
  return new Promise((_0x3258f9, _0x1a70fa) => {
    TribalWars.post(Accountmanager.send_units_link_from_report, null, {
      'report_id': _0x2c8a9c(_0xc51f8.reportUrl)
    }, _0x54dfe4 => {
      if (typeof _0x54dfe4.success === "string") {
        UI.SuccessMessage(_0x54dfe4.success, 4000);
        Accountmanager.farm.updateOwnUnitsAvailable(_0x54dfe4.current_units);
      }
...
async function _0x525b8a(_0x50ca12) {
  const _0x4af601 = _0x50ca12.farmEntryInfo;
  const _0x44fa95 = _0x50ca12.docInfo;
  let _0x45b9d1 = _0x1a91d3();
  if (_0x45b9d1 < _0x4af601.wallLevel) {
    return false;
  }
  let _0x577e37 = _0x4726f5(_0x4af601.wallLevel);
  let _0x106aa5 = await _0x13d557(_0x44fa95, _0x577e37);
  if (!_0x106aa5) {
    return false;
  }
...
async function _0x407d08(_0x56974e) {
  const _0x16d52f = _0x56974e.farmEntryInfo;
  const _0x30b6af = _0x56974e.docInfo;
  if (parseInt(Accountmanager.farm.current_units.spy) < 1) {
    return;
  }
  let _0x2f00d1 = await _0x13d557(_0x30b6af, {
    'spy': 0x1
  });
  if (!_0x2f00d1) {
    return;
...
async function _0x5b6fee(_0xf72612, _0x55d354) {
  const _0x3e34fc = _0xf72612.farmEntryInfo;
  const _0x660782 = _0xf72612.docInfo;
  if (_0x3e34fc.wallLevel > 0) {
    return;
  }
  for (let _0x59a61d = 0; _0x59a61d < _0x55d354.length; _0x59a61d++) {
    let _0x7a8ca5 = _0x55d354[_0x59a61d].id;
    let _0x125e0a = _0x55d354[_0x59a61d].attacks;
    let _0x345713 = 0;
    for (; _0x345713 < _0x125e0a.length; _0x345713++) {
      let _0xc57d61 = _0x125e0a[_0x345713];
      let _0x55667e = _0xec7eb3.sendAxesWithCat ? 4 : 0;
...
function _0x4980f5(_0x2fc5d9, _0x2340ff, _0x528d2d, _0x14620f) {
  let _0x36e03e = _0x2fc5d9.coordinates;
  let _0x33125e = _0x528d2d || _0x14620f ? "ram" : _0x44047c(_0x2fc5d9, _0x2340ff, true);
  let _0x2d69a0 = new Date(new Date().getTime() + _0x11e607(_0x2fc5d9.distance, _0x33125e));
  if (_0x14620f) {
...
function _0x11e607(_0x1ebad7, _0x56cf22) {
  let _0x36aadf = _0x15b6a2.config.speed;
  let _0x2e94e0 = _0x15b6a2.config.unit_speed;
  let _0x26902e = _0x21dfdf[_0x56cf22];
  return 1000 * Math.round(_0x1ebad7 * (_0x26902e / _0x36aadf / _0x2e94e0));
}
function _0x25d0a0(_0x3df92c, _0x23f6c0) {
  let _0x5abf3c = _0x3df92c.childNodes;
  let _0x324b37 = _0x5abf3c[5].childNodes;
  let _0x19c23e = _0x5abf3c[7].childNodes[0];
  let _0x4bb070 = _0x3d1f50(_0x19c23e.innerText)[0];
  let _0x36d1fe = parseFloat(_0x5abf3c[15].textContent);
  let _0x3e5bcb = _0x5abf3c[21].childNodes[1];
  let _0x5243b6 = _0x3e5bcb.nodeName === "SPAN" ? undefined : _0x3e5bcb;
  return {
    'farmEntryInfo': {
      'index': _0x23f6c0,
      ...
      'haulStatus': _0x324b37.length > 0 ? _0x1d122d(_0x324b37[0].src) : "nonFullHaul",
      'knownAttacks': 0x0,
...
function _0x1a91d3() {
  for (let _0x4dddfa = 20; _0x4dddfa > 0; _0x4dddfa--) {
...
async function _0x24d4ad(_0x1e78cd) {
  ...
  let _0x4ea6ab = false;
  let _0x450413 = await _0xe59a71(_0x1e78cd.coordinates);
  ...
  if ((_0x1e78cd.lastReportStatus === "blue" || _0x1e78cd.resources > 0) && (!_0x450413.buildingBreakTrack.lastReportId || _0x450413.buildingBreakTrack.lastReportId !== _0x3f90dd)) {
    _0x450413.buildingBreakTrack.lastReportId = _0x3f90dd;
    let _0x1f96ce = await _0x385820(_0x1e78cd.reportUrl);
    let _0x3c2305 = 10;
  ...
  return new Promise(function (_0x34a9f2, _0xa7084c) {
    $.ajax({
      ...
      'success': function (_0xac834c) {
        let _0xa42065 = new DOMParser().parseFromString(_0xac834c, "text/html");
        let _0x5dcbd4 = _0xa42065.getElementById("attack_spy_building_data")?.["getAttribute"]("value");
...
async function _0x13d557(_0x45df41, _0x1ee195, _0x45395b) {
  ...
  await _0x3d40d2(_0xec7eb3.farmTimeout);
  return await _0x37cb7f(_0x1ee195, _0x45395b);
}
async function _0x37cb7f(_0x378645, _0x129250) {
  for (const [_0x5240b8, _0x38fa76] of Object.entries(_0x378645)) document.getElementById("unit_input_" + _0x5240b8).value = _0x38fa76;
...
function _0x9b7a2e(_0x2702aa, _0xfc9e4c) {
  window.addEventListener("unload", async _0x5a1011 => {
  ...
  return new Promise((_0x460ca6, _0x134a36) => {
...
async function _0x58ed3b(_0x43f32e, _0x3b69e7) {
  try {
    const _0x22a169 = _0x1119e1.transaction(_0x39c868.indexedDBObjectStoreName, "readwrite");
    const _0x5d1383 = _0x22a169.objectStore(_0x39c868.indexedDBObjectStoreName);
...
async function _0xe59a71(_0x476e4a) {
  try {
    const _0x18bb2d = _0x1119e1.transaction(_0x39c868.indexedDBObjectStoreName, "readonly");
    const _0x135987 = _0x18bb2d.objectStore(_0x39c868.indexedDBObjectStoreName);
    const _0x3e4a7f = _0x135987.get(_0x476e4a);
  ...
  if (typeof Worker) {
    try {
      ...
      window.clearInterval = function (_0x2a896d) {
        if (_0x132286.hasOwnProperty(_0x2a896d)) {
          delete _0x132286[_0x2a896d];
          _0x23cf8b.postMessage({
            'name': "clearInterval",
            'fakeId': _0x2a896d
          });
      ...
      window.clearTimeout = function (_0x5965f7) {
        if (_0x132286.hasOwnProperty(_0x5965f7)) {
          delete _0x132286[_0x5965f7];
          _0x23cf8b.postMessage({
            'name': "clearTimeout",
            'fakeId': _0x5965f7
          });
      ...
      _0x23cf8b.onmessage = function (_0x16cdad) {
        let _0x154db3 = _0x16cdad.data;
        let _0x3c7880 = _0x154db3.fakeId;
        let _0x4ce44c;
        let _0x1d2e0f;
        let _0x49377c;
...
async function _0x5897e2() {
  ...
  if (_0x12aae7.length === 1) {
    let _0x24ae3d = $("#plunder_list_nav tr:first td:last").children();
    let _0x7e9588;
    ...
    const _0x28a246 = new _0x48fae1(2);
    const _0x3b73a6 = Array(_0x7e9588 - 1).fill().map((_0x3ee942, _0xa1f09a) => _0x1a0e75(() => _0x28a246.acquire().then(() => _0x2001fd(_0xa1f09a + 1)["finally"](() => {
      _0x28a246.release();
    })), 5));
    const _0x41236a = await Promise.allSettled(_0x3b73a6);
...
function _0x46ac48() {
  ...
  let _0x5f5166 = parseInt(_0xec7eb3.refreshTimeout);
  let _0x55b1f4 = _0x5f5166 + _0x383a5d(0, _0x5f5166 / 10);
...
function _0x1e5868(_0x146977) {
  ...
  window.top.$.ajax({
    ...
    'error': function (_0x51806c, _0x15a27c) {
      let _0x85f626 = parseInt(_0xec7eb3.refreshTimeout);
      let _0x23408e = _0x85f626 + _0x383a5d(0, _0x85f626 / 10);
    ...
    'success': function (_0x14e3e3) {
      let _0x4132c = window.top.$(_0x14e3e3);
      let _0x1428ea = /<\s*title\s*>([^<]+)<\/title\s*>/g.exec(_0x14e3e3);
      let _0x514869 = _0x1428ea[1];
      let _0x5a9124 = window.top.$.parseJSON(_0x14e3e3.split("TribalWars.updateGameData(")[1].split(');')[0]);
      _0x4d9c6b = _0x5a9124;
  ...
  try {
    ...
    if (_0x2a5be5.children.length > 0) {
      for (let _0x4d9013 = 0; _0x4d9013 < _0x2a5be5.children.length; _0x4d9013++) {
        const _0x3a975c = _0x2a5be5.children.item(_0x4d9013);
        const _0x183707 = _0x3a975c.nodeName;
        if (typeof _0x54d5bd[_0x183707] == "undefined") {
          _0x54d5bd[_0x183707] = _0x25db3b(_0x3a975c);
        } else {
...
function _0x22b063(_0x46f787, _0x2716e2) {
  return new Promise(_0x38a061 => {
    ...
    const _0x2f58e9 = new MutationObserver(_0x8c7749 => {
      if (document.querySelector(_0x46f787)) {
        _0x38a061(document.querySelector(_0x46f787));
...
async function _0x2ece06() {
  let _0xdd2595 = await _0x145fb1();
  let _0x2712c0 = _0xec7eb3.safeMode ? 2 : navigator.hardwareConcurrency;
...
function _0x1f4bf8(_0x42c8d6) {
  const _0x1f5c27 = new Blob([_0x42c8d6], {
    'type': "application/javascript"
  });
  const _0x545720 = URL.createObjectURL(_0x1f5c27);
...
async function _0x54dea1(_0x9430b7) {
  const _0x3fe30f = [];
  const _0x6873a7 = [];
  const _0x2ff904 = _0x9430b7.length;
  if (_0x2ff904 <= 0) {
    return _0x6873a7;
  }
  const _0x2ca868 = new ArrayBuffer(4);
  const _0x550caf = new Uint32Array(_0x2ca868);
  _0x550caf[0] = 0;
  for (let _0x5e76be = 0; _0x5e76be < Math.min(_0x2ff904, _0x464e13.length); _0x5e76be++) {
    let _0x227846 = Atomics.add(_0x550caf, 0, 1);
    ...
    let _0x3e4bb7 = new Promise((_0x5d2274, _0x27147e) => {
      _0x405e87.onmessage = _0x405dc5 => {
        ...
        let _0x11ffe3 = Atomics.add(_0x550caf, 0, 1);
...
function _0x45bfcf() {
  ...
  let _0x2e91d5 = Object.values(Accountmanager.farm.templates);
  for (let _0x4d991f = 0; _0x4d991f < 2; _0x4d991f++) {
    for (const [_0x33e54d, _0x56cb57] of Object.entries(_0x2e91d5[_0x4d991f])) if (_0x56cb57 > 0 && _0x21dfdf[_0x33e54d] > _0x21dfdf[_0x362702[_0x234a8f[_0x4d991f]]]) {
...
function _0x1e4dad() {
  for (let _0x1f4dd5 = 0; _0x1f4dd5 < _0x464e13.length; _0x1f4dd5++) {
    _0x464e13[_0x1f4dd5].postMessage({
      'job': "killWorker"
    });
  }
}
